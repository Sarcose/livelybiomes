...
public class PsychicBiome : IBiome
{
	...
	public override int GetBiomeValue(string ZoneID)
	{
		...
		XRL.World.GameObject terrainObjectForZone = ZoneManager.GetTerrainObjectForZone(ParasangX, ParasangY, World);
	...
	public override XRL.World.GameObject MutateGameObject(XRL.World.GameObject Object, string ZoneID)
	{
